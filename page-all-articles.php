			...
			<?php while ( have_posts() ) : the_post(); ?>
				...
				<article id="post-<?php the_ID(); ?>" <?php post_class(); ?>>
					...
					<div class="entry-content">
						...
						echo "<p>That's a total of <strong>$totalPosts posts</strong> and counting!</p><p>Some of these are longer articles, some are only single pictures. The most recent post is at the top of this list. Explore at your own risk!</p>";
						$args = array(
							'type'            => 'postbypost',
							'limit'           => '',
							'format'          => 'html', 
